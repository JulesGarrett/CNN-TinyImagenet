...
#conv1 + relu> pooled1 > conv2 + relu > pooled2 > conv3 + relu > conv4 + relu > conv5 + relu > pooled3 > fc + relu > fc
    ...
    dpool2, df3, db3 = cnn.conv_back(dconv3, pooled2, f3, conv_s) # backpropagate previous gradient through second convolutional layer.
    ...
    dpool1, df2, db2 = cnn.conv_back(dconv2, pooled1, f2, conv_s) # backpropagate previous gradient through second convolutional layer.
